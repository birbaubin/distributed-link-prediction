...
NEW_PROTOCOL_SRC=src/new_dist_link_prediction/inline_protocole.cpp
OBJ=*.o
OPENSSL_FLAGS=-I/opt/homebrew/Cellar/openssl@3/3.0.7/include -L/opt/homebrew/Cellar/openssl@3/3.0.7/lib -lssl -lcrypto
GMP_FLAGS= -lgmp
BOOST_FLAGS=-I/opt/homebrew/Cellar/boost/1.80.0/include -L/opt/homebrew/Cellar/boost/1.80.0/lib -lboost_chrono
STDFLAG=-std=c++17



all: helpers crypto tests new_protocol main
