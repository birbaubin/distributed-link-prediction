import random
from deeprobust.graph.data import Dataset, Pyg2Dpr, AmazonPyg, CoauthorPyg
import numpy as np
import pandas as pd
import torch

PROJET_PATH = "/Users/aubinbirba/Works/optimized-distributed-link-prediction/distributed-link-prediction"
...
network1.to_csv(PROJET_PATH + "/datasets/" + "net1-" + DATASET_NAME + ".csv", header=False, index=False)
network2.to_csv(PROJET_PATH + "/datasets/" + "net2-" + DATASET_NAME + ".csv", header=False, index=False)
